...
const WEBSITES_EN: WebsiteEntry[] = [
  ...
  { title: "Radio Garden", description: "Listen to live radio from around the world by rotating a 3D globe.", url: "https://radio.garden" },
  ...
  { title: "Zoom Quilt", description: "Infinite zoom through collaborative art. Click to zoom in forever.", url: "https://zoomquilt.org" },
  ...
  { title: "GeoGuessr", description: "You're dropped somewhere on Earth. Use street view to guess where you are.", url: "https://www.geoguessr.com" },
...
const WEBSITES_KO: WebsiteEntry[] = [
  ...
  { title: "Radio Garden", description: "3D 지구를 돌리며 전 세계 라이브 라디오를 들을 수 있습니다.", url: "https://radio.garden" },
  ...
  { title: "Zoom Quilt", description: "협업 아트 속으로 무한 줌인. 클릭하면 끝없이 들어갑니다.", url: "https://zoomquilt.org" },
  ...
  { title: "GeoGuessr", description: "지구 어딘가에 떨어져 스트리트 뷰로 위치를 맞춰보세요.", url: "https://www.geoguessr.com" },
